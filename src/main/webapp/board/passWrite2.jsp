...
<html>
 ...
 <script>
 	$(function() {
 		...
 		//출력화면의 넓이로 댓글과 본글 삭제 구별
 		if( bw >= 500) url = "myboardDelete"; 
   			...
   			$.ajax({
				...
				data	 :form,   		 	// 전송 데이터
   				...
   				success  : function(data) {  
					if( data == "1" ) {   
						alert("삭제 성공!");
						if( bw >= 500) location = "/myboardList";
						else {
							opener.location.reload();
							self.close();
						}
					} 
					else if( data == "2" ) alert("암호를 잘못 입력했습니다.!");
					else if( data == "3" ) alert("하위 댓글이 존재하여 코맨트만 비웠습니다.");
					else 				   alert("삭제 실패!");	
   				},
 ...
 <body>
 	<div class="div_title" style="width:300px;">암호 입력 화면</div>
	<form id="frm">
	    ...
	    <div class="div_button_area" style="width:300px;">
