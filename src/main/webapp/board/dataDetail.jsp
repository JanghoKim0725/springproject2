...
<html>
 ...
 <script>	
 	$(function() {	
 		...
 		$("#btn_before").click(function() {
 			if(${dto.bseqid} > 0) location = "/dataDetail/${dto.bseqid}";
 			else alert("이전 내용이 없습니다.");
 		});
 		
 		$("#btn_next"  ).click(function() {
 			if(${dto.nseqid} > 0) location = "/dataDetail/${dto.nseqid}";
 			else alert("다음 내용이 없습니다.");
 		});
 		
 		$("#btn_list"  ).click(function() {location = "/dataList";});
 		
 		$("#btn_modify").click(function() {location = "/dataModify/${dto.seqid}";});
 		
 		$("#btn_delete").click(function() {
 			let url = "/dataPassWrite/${dto.seqid},${dto.filename}";
 ...
 <body>
 	<form id="frm">
	 	<div class="div_title">자료게시판 상세화면</div>
		<table class="table1">
			<colgroup>
				<col width="20%"/>
				<col width="*"  />
